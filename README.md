...
```
    ...
    ## 
    ##   
       checking for file ‘/private/var/folders/b4/js7mglf90_v3gc6_2rl943vc0000gn/T/RtmpTWCN5F/remotes2d9d79264785/traitecoevo-growthform-f6f5623/DESCRIPTION’ ...
      
    ✔  checking for file ‘/private/var/folders/b4/js7mglf90_v3gc6_2rl943vc0000gn/T/RtmpTWCN5F/remotes2d9d79264785/traitecoevo-growthform-f6f5623/DESCRIPTION’
    ## 
      
    ─  preparing ‘growthform’:
    ## 
    ...
    ─  building ‘growthform_0.2.3.tar.gz’
    ## 
...
```
    ...
    ## 1  Acacia longifolia       F                TRUE
    ## 2 Clematis lasiantha       C                TRUE
    ## 3      Ficus tremula       H                TRUE
    ## 4       Hedera helix       C                TRUE
    ## 5     Najas flexilis       A                TRUE
    ## 6  Quercus agrifolia       F                TRUE
